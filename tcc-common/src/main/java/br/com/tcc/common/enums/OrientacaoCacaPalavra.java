...
/**
 * Enumeração OrientacaoCacaPalavra
 */
@JsonFormat(shape = JsonFormat.Shape.OBJECT)
public enum OrientacaoCacaPalavra {
     ...
     */
    private OrientacaoCacaPalavra(final String newId, final String descricao) {
        this.id = newId;
     ...
     */
    public static OrientacaoCacaPalavra from(final String valor) {
        if (valor == null) {
            throw new NullPointerException();
        }

        for (OrientacaoCacaPalavra e : OrientacaoCacaPalavra.values()) {
