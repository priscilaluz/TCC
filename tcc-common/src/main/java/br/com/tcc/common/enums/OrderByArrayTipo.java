...
public enum OrderByArrayTipo {
     ...
     */
    private OrderByArrayTipo(final String newId, final String descricao) {
        this.id = newId;
     ...
     */
    public static OrderByArrayTipo from(final String valor) {
        if (valor == null) {
            throw new NullPointerException();
        }

        for (OrderByArrayTipo e : OrderByArrayTipo.values()) {
