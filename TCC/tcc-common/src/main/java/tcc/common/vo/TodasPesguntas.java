...
public class TodasPesguntas {
    private static final String EXEMPLO_1 = "No mundo artístico: Beatriz, Bruna e Patrícia são três garotas talentosas que estão tentando entrar no mundo artístico, cada qual numa atividade diferente (uma delas quer ser atriz). Entretanto, por enquanto elas ainda não podem deixar seus empregos (uma delas é bancária) para se dedicar à atividade artística a que almejam, Com base nas dicas e informações que fornecemos, tente descobrir o nome de cada garota, a profissão atual de cada uma e o que elas desejam ser no mundo artístico. Dicas: \n" +"a) Patrícia quer ser atriz \n" +"b) A bancária quer ser cantora \n" +"c) Bruna não é bancária nem enfermeira";
